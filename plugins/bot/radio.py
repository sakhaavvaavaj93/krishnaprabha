...
@Client.on_message(filters.command(["radio", f"radio@{USERNAME}"]) & ADMINS_FILTER & filters.private | filters.chat)
...
@Client.on_message(filters.command(["stopradio", f"stopradio@{USERNAME}"]) & ADMINS_FILTER & filters.private | filters.chat)
